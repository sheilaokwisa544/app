...
import coil.compose.rememberAsyncImagePainter  // dependency for images
        ...
        Scaffold(
            bottomBar = {
                NavigationBar (
                    ...
                    com.example.appy.ui.theme.screens.products.bottomNavItems.forEachIndexed { index, bottomNavItem ->
                        NavigationBarItem(
            ...
            content = @Composable{
                Column(
                    ...
                    LazyColumn(){
                        items(students){
                            com.example.appy.ui.theme.screens.students.StudentItem(
                                name = it.name,
                                age = it.age,
                               email = it.email,
...
@Composable
fun StudentItem(name:String, age:String, email:String, id:String,
